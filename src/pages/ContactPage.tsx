  ...
  return (
    <div>
      <SEO 
        ...
        description="Contact Rudrakshya Barman for business inquiries, collaboration opportunities, or to connect about technology ventures in healthcare and educational sectors."
        keywords="contact, business inquiry, collaboration, technology ventures, healthcare technology, educational technology, software development, machine learning"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">My Ventures</h2>
