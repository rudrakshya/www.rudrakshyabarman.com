...
export default function CollaborationPage() {
  return (
    <div>
      <SEO 
        title="Collaboration - Partner with a Technology Leader"
        description="Explore collaboration opportunities with Rudrakshya Barman for investment, academic partnerships, mentorship, technical projects, and community engagement in healthcare and educational technology."
        keywords="collaboration, partnership, investment, academic partnership, mentorship, technical projects, community engagement, healthcare technology, educational technology"
      />
