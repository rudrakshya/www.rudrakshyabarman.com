...
export default function HomePage() {
  ...
  return (
    <>
      <SEO 
        title="Home - Software Engineer & Entrepreneur"
        ...
        keywords="software engineer, entrepreneur, technology leader, healthcare technology, educational technology, machine learning, full-stack development, startup founder"
      />
