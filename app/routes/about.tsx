...
export function meta({}: Route.MetaArgs) {
  ...
  return [
    ...
    { name: "keywords", content: "software engineer, entrepreneur, technology leader, healthcare technology, educational technology, career journey, professional experience, machine learning, full-stack development" },
