...
export function meta({}: Route.MetaArgs) {
  ...
  return [
    ...
    { name: "keywords", content: "technology ventures, healthcare software, educational technology, SaaS products, software development, machine learning, mobile applications, enterprise solutions" },
    ...
    { property: "og:image:alt", content: "Rudrakshya Barman Projects" },
    ...
    { name: "twitter:image:alt", content: "Rudrakshya Barman Projects" },
